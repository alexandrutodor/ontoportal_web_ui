  ...
  config.descriptions_source = ->(keys) do
    {
      ...
      "datasets" => "Enables the generic read-only dataset catalogue and detail pages. Requires DATASETS_API_URL on the server.",
      "models_catalogue" => "Enables the read-only Models catalogue. Disabled by default.",
      "workflows_catalogue" => "Enables the read-only Workflows catalogue. Disabled by default.",
      "repositories_catalogue" => "Enables the read-only Repositories catalogue. Disabled by default."
    }
  end
